...
<p class="introduction">
  UTエイム様の会社説明のための、就活生に向けたウェブパンフレットを制作させていただきました。
  <br />
  スマートフォンの画面をミラーリングして表示しながら説明できるように、内容に合わせてアニメーションを細かく調整しながら実装しました。
</p>
<p class="img">
  <img
...
<div class="introduction">
  <p>
    ...
    <br />
    写真撮影時にはラフスケッチや資料を作成し、無機質にならないように小物を配置するなど、お店のこだわりが反映されるようカメラマンと協力・対応しました。
  </p>
</div>
...
<p class="img"><img src="/images/works/osozakura/osozakura_12.jpg" /></p>
